...
public class ImageAdapter extends BaseAdapter {
	...
	private Integer[] mThumbIds = { R.drawable.add_user,
			...
			R.drawable.delete_user, R.drawable.set_bt, R.drawable.set_network};
	
	// references to our images
	private String[] texts = { "Add New User", "Update Existing Person",
			"Identify People", "Live Recognition", "Reset Album",
			"Delete Existing User", "Set BlueTooth", "Set Network",
